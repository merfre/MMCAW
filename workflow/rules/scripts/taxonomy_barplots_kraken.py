...
plt.title(print("Barplot of top " + str(prevno) + " species prevalence from Kraken2 results"))
...
# change color with: color=[''], barh makes plot horizontal
plt.title(print("Barplot of top " + str(prevno) + " family prevalence from Kraken2 results"))
plt.xlabel("Prevalence")
plt.ylabel("Families")
plt.tight_layout()
# tight layout needed to not cut off species names
...
# change color with: color=[''], barh makes plot horizontal
plt.title(print("Barplot of top " + str(prevno) + " class prevalence from Kraken2 results"))
plt.xlabel("Prevalence")
plt.ylabel("Classes")
plt.tight_layout()
# tight layout needed to not cut off species names
...
# change color with: color=[''], barh makes plot horizontal
plt.title(print("Barplot of top " + str(prevno) + " kingdom prevalence from Kraken2 results"))
plt.xlabel("Prevalence")
plt.ylabel("Kingdoms")
plt.tight_layout()
# tight layout needed to not cut off species names

...
sample = sample.drop(["classified","query", "taxid","length","score"], axis=1).groupby(["species","genus","family","order","class","phylum","kingdom"]).size().to_frame(name = sample_no + "_kraken").reset_index()

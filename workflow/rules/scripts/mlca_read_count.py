...
sample = sample.drop(["query", "lca_rank","lca_otu","method"], axis=1).groupby(["species","genus","family","order","class","phylum","kingdom"]).size().to_frame(name = sample_no + "_blast").reset_index()

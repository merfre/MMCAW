...
cat_species_top = cat_species.nlargest(int(prevno),'prevalence')
...
cat_family_top = cat_family_nonrepeat.nlargest(int(prevno),'prevalence')
...
cat_class_top = cat_class_nonrepeat.nlargest(int(prevno),'prevalence')

...
# barplot of top 25 most prevalent species from cat results
...
cat_species_top25 = cat_species.nlargest(25,'prevalence')
cat_species_barplot = cat_species_top25['prevalence'].plot(kind="barh")
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 species prevalence from CAT results")
...
# barplot of top 25 most prevalent families from cat results
...
cat_family_top25 = cat_family_nonrepeat.nlargest(25,'prevalence')
cat_family_barplot = cat_family_top25['prevalence'].plot(kind="barh")
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 family prevalence from CAT results")
plt.xlabel("Prevalence")
plt.ylabel("Families")
plt.tight_layout()
# tight layout needed to not cut off species names
...
cat_class_top25 = cat_class_nonrepeat.nlargest(25,'prevalence')
cat_class_barplot = cat_class_top25['prevalence'].plot(kind="barh")
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 class prevalence from CAT results")
plt.xlabel("Prevalence")
plt.ylabel("Classes")
plt.tight_layout()
# tight layout needed to not cut off species names
...
# barplot of top 25 most prevalent kingdoms from cat results
...
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 kingdom prevalence from CAT results")
plt.xlabel("Prevalence")
plt.ylabel("Kingdoms")
plt.tight_layout()
# tight layout needed to not cut off species names

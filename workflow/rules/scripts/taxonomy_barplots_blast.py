...
# barplot of top 25 most prevalent species from blast results
...
blast_species_top25 = blast_species.nlargest(25,'prevalence')
blast_species_barplot = blast_species_top25['prevalence'].plot(kind="barh")
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 species prevalence from BLAST results")
...
# barplot of top 25 most prevalent families from blast results
...
blast_family_top25 = blast_family_nonrepeat.nlargest(25,'prevalence')
blast_family_barplot = blast_family_top25['prevalence'].plot(kind="barh")
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 family prevalence from BLAST results")
plt.xlabel("Prevalence")
plt.ylabel("Families")
plt.tight_layout()
# tight layout needed to not cut off species names
...
blast_class_top25 = blast_class_nonrepeat.nlargest(25,'prevalence')
blast_class_barplot = blast_class_top25['prevalence'].plot(kind="barh")
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 class prevalence from BLAST results")
plt.xlabel("Prevalence")
plt.ylabel("Classes")
plt.tight_layout()
# tight layout needed to not cut off species names
...
# barplot of top 25 most prevalent kingdoms from blast results
...
# change color with: color=[''], barh makes plot horizontal
plt.title("Barplot of top 25 kingdom prevalence from BLAST results")
plt.xlabel("Prevalence")
plt.ylabel("Kingdoms")
plt.tight_layout()
# tight layout needed to not cut off species names
